...
com.stype = {
	...
	stype3:{
		...
		spaceX:80,		//�ŵ�X���
		spaceY:79.5,		//�ŵ�Y���
		pointStartX:155,		//��һ���ŵ�X����;
		pointStartY:120,		//��һ���ŵ�Y����;
		page:"stype_3"	//ͼƬĿ¼
	}			
}
//��ȡID
...
window.onload = function(){  
	...
	com.get("billBn").addEventListener("click", function(e) {
		if (confirm("Whether to end the game and start chess research��")){
			com.init();
	...
	com.get("superPlay").addEventListener("click", function(e) {
		if (confirm("Confirm to start hard game��")){
			play.isPlay=true ;	
...
com.loadImages = function(stype){
	...
	//��������
	com.bgImg = new Image();
	com.bgImg.src  = "/chess/img/"+stype+"/bg.png";
	
	//��ʾ��
	com.dotImg = new Image();
	com.dotImg.src  = "/chess/img/"+stype+"/dot.png";
	
	//����
	for (var i in com.args){
		com[i] = {};
		com[i].img = new Image();
		com[i].img.src = "/chess/img/"+stype+"/"+ com.args[i].img +".png";
	}
	
	//�������
	com.paneImg = new Image();
	com.paneImg.src  = "/chess/img/"+stype+"/r_box.png";
...
com.args={
	//���� ����/ͼƬ��ַ/��Ӫ/Ȩ��
	'c':{text:"Chariot", img:'r_c', my:1 ,bl:"c", value:com.value.c},
	'm':{text:"Horse", img:'r_m', my:1 ,bl:"m", value:com.value.m},
	'x':{text:"Elephant", img:'r_x', my:1 ,bl:"x", value:com.value.x},
	's':{text:"Guard", img:'r_s', my:1 ,bl:"s", value:com.value.s},
	'j':{text:"General", img:'r_j', my:1 ,bl:"j", value:com.value.j},
	'p':{text:"Cannons", img:'r_p', my:1 ,bl:"p", value:com.value.p},
	'z':{text:"Soldier", img:'r_z', my:1 ,bl:"z", value:com.value.z},
	
	//����
	'C':{text:"Chariot", img:'b_c', my:-1 ,bl:"c", value:com.value.C},
	'M':{text:"Horse", img:'b_m', my:-1 ,bl:"m", value:com.value.M},
	'X':{text:"Elephant", img:'b_x', my:-1 ,bl:"x", value:com.value.X},
	'S':{text:"Guard", img:'b_s', my:-1 ,bl:"s", value:com.value.S},
	'J':{text:"General", img:'b_j', my:-1 ,bl:"j", value:com.value.J},
	'P':{text:"Cannons", img:'b_p', my:-1 ,bl:"p", value:com.value.P},
	'Z':{text:"Soldier", img:'b_z', my:-1 ,bl:"z", value:com.value.Z}
